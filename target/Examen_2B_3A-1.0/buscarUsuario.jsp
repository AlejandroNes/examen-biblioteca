<%-- 
    ...
    Created on : 15 jun. de 2021, 23:36:50
    Author     : Elementrix
--%>
  ...
  <div class="container-fluid">
    ...
    <!--<div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        ...
        <h1>BUSQUEDA DE USUSARIO</h1>
        <jsp:useBean id="UsuarioBean" scope="session" class="com.test.bean.Usuariobean"/>
        <form method="POST">
            <table border="1" bgcolor="#aabbcc">
            <thead>
                <tr>
                    <th>BUSCAR USUARIO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                        <td>NOMBRE DE USUARIO : </td>
                        <td><input type="text" name="user" placeholder="Ingrese nombre de Usuario"></td>
                    </tr>
                    <tr>
